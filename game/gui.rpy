...
## 用於主選單和遊戲選單的影像 (縮放至 1920x1080 填滿全螢幕)
define gui.main_menu_background = Transform("gui/main_menu.png", xsize=1920, ysize=1080)
define gui.game_menu_background = Transform("gui/game_menu.png", xsize=1920, ysize=1080)
